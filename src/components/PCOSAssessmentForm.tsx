      ...
      case 2:
        return (
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div>
                <Label>How often do you get your period? *</Label>
                <RadioGroup 
                  value={formData.periodFrequency} 
                  onValueChange={(value) => handleInputChange('periodFrequency', value)}
                  className="mt-2"
                >
              ...
              <div>
                ...
                <RadioGroup 
                  ...
                  onValueChange={(value) => handleInputChange('flowIntensity', value)}
                  className="mt-2"
                >
                  <div className="flex items-center space-x-2">
          ...
          <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3">
                {moodSymptoms.map((symptom) => (
                  <div key={symptom} className="flex items-center space-x-2">
                    <Checkbox
                      id={symptom}
                      checked={formData.moodSymptoms.includes(symptom)}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Select value={formData.acneSeverity} onValueChange={(value) => handleInputChange('acneSeverity', value)}>
                  <SelectTrigger>
              ...
              <div>
                <Label>Weight changes in past year</Label>
                <Select value={formData.weightChanges} onValueChange={(value) => handleInputChange('weightChanges', value)}>
                  <SelectTrigger>
      ...
      case 4:
        return (
          <div className="space-y-4">
            ...
            <div>
              <Label>Family history of PCOS, diabetes, or fertility issues?</Label>
              <RadioGroup 
            ...
            <div>
              <Label htmlFor="additionalNotes">Additional notes or concerns</Label>
              <Textarea
                id="additionalNotes"
